...
urlpatterns = patterns('',
    ...
    #url(r'^register/$', 'registration.views.register',{'backend': 'accounts.regbackend.Backend','form_class' : UserRegistrationForm},name='registration_register'),
    ...
    url(r'^register/$',UserRegistration.as_view(form_class=RegistrationForm),name='registration_register'),
