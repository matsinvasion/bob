...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OrderList.user'
        db.add_column(u'orders_orderlist', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=18, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OrderList.user'
        db.delete_column(u'orders_orderlist', 'user_id')
