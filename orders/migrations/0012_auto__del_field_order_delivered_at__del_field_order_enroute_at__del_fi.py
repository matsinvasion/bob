...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Order.delivered_at'
        db.delete_column(u'orders_order', 'delivered_at')

        # Deleting field 'Order.enroute_at'
        db.delete_column(u'orders_order', 'enroute_at')

        # Deleting field 'Order.cancelled_at'
        db.delete_column(u'orders_order', 'cancelled_at')

        # Adding field 'Order.mobile'
        db.add_column(u'orders_order', 'mobile',
                      self.gf('django.db.models.fields.CharField')(default='0785559899', max_length=15),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Order.delivered_at'
        db.add_column(u'orders_order', 'delivered_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'Order.enroute_at'
        db.add_column(u'orders_order', 'enroute_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'Order.cancelled_at'
        db.add_column(u'orders_order', 'cancelled_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Deleting field 'Order.mobile'
        db.delete_column(u'orders_order', 'mobile')
    ...
    models = {
        ...
        u'orders.orderlist': {
            ...
            'scheduled_time': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
