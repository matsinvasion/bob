...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OrderList.order'
        db.add_column(u'orders_orderlist', 'order',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='order_lists', null=True, to=orm['orders.Order']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OrderList.order'
        db.delete_column(u'orders_orderlist', 'order_id')
