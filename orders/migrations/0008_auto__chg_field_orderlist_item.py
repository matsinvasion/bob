...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'OrderList.item'
        db.alter_column(u'orders_orderlist', 'item_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['items.Item'], null=True))

    def backwards(self, orm):

        # Changing field 'OrderList.item'
        db.alter_column(u'orders_orderlist', 'item_id', self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['items.Item']))
    ...
    models = {
        ...
        u'items.item': {
            ...
            'qty': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
        ...
        u'orders.orderlist': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'item': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['items.Item']", 'null': 'True'}),
