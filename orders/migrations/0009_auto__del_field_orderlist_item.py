...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'OrderList.item'
        db.delete_column(u'orders_orderlist', 'item_id')


    def backwards(self, orm):
        # Adding field 'OrderList.item'
        db.add_column(u'orders_orderlist', 'item',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['items.Item'], null=True),
                      keep_default=False)
