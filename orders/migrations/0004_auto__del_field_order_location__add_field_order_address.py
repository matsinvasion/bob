...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Order.location'
        db.delete_column(u'orders_order', 'location_id')

        # Adding field 'Order.address'
        db.add_column(u'orders_order', 'address',
                      self.gf('django.db.models.fields.CharField')(default='kigali', max_length=140),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Order.location'
        db.add_column(u'orders_order', 'location',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['customers.Location'], null=True),
                      keep_default=False)
