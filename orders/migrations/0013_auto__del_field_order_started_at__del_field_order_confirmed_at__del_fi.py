...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Order.started_at'
        db.delete_column(u'orders_order', 'started_at')

        # Deleting field 'Order.confirmed_at'
        db.delete_column(u'orders_order', 'confirmed_at')

        # Deleting field 'Order.paid_at'
        db.delete_column(u'orders_order', 'paid_at')

        # Deleting field 'Order.recruited_at'
        db.delete_column(u'orders_order', 'recruited_at')


    def backwards(self, orm):
        # Adding field 'Order.started_at'
        db.add_column(u'orders_order', 'started_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'Order.confirmed_at'
        db.add_column(u'orders_order', 'confirmed_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'Order.paid_at'
        db.add_column(u'orders_order', 'paid_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'Order.recruited_at'
        db.add_column(u'orders_order', 'recruited_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)
