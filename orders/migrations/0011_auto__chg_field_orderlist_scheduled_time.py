...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'OrderList.scheduled_time'
        db.alter_column(u'orders_orderlist', 'scheduled_time', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'OrderList.scheduled_time'
        db.alter_column(u'orders_orderlist', 'scheduled_time', self.gf('django.db.models.fields.CharField')(default='today', max_length=100))
