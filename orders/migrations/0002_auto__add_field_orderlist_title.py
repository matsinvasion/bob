...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OrderList.title'
        db.add_column(u'orders_orderlist', 'title',
                      self.gf('django.db.models.fields.CharField')(default=datetime.datetime(2014, 8, 31, 0, 0), max_length=60),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OrderList.title'
        db.delete_column(u'orders_orderlist', 'title')
