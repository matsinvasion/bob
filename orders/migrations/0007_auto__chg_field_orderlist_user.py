...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'OrderList.user'
        db.alter_column(u'orders_orderlist', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

    def backwards(self, orm):

        # Changing field 'OrderList.user'
        db.alter_column(u'orders_orderlist', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(default=18, to=orm['auth.User']))
