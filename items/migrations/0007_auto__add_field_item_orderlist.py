...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Item.orderlist'
        db.add_column(u'items_item', 'orderlist',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['orders.OrderList'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Item.orderlist'
        db.delete_column(u'items_item', 'orderlist_id')
