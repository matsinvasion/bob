...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Item.qty'
        db.alter_column(u'items_item', 'qty', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Item.qty'
        db.alter_column(u'items_item', 'qty', self.gf('django.db.models.fields.IntegerField')())
