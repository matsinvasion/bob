...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Item.qty'
        db.delete_column(u'items_item', 'qty')

        # Deleting field 'Item.unit'
        db.delete_column(u'items_item', 'unit')

        # Deleting field 'Item.item'
        db.delete_column(u'items_item', 'item')

        # Adding field 'Item.item_description'
        db.add_column(u'items_item', 'item_description',
                      self.gf('django.db.models.fields.CharField')(default='default item', max_length=140),
                      keep_default=False)

        # Adding field 'Item.note'
        db.add_column(u'items_item', 'note',
                      self.gf('django.db.models.fields.TextField')(max_length=140, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Item.qty'
        db.add_column(u'items_item', 'qty',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Item.unit'
        db.add_column(u'items_item', 'unit',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Item.item'
        db.add_column(u'items_item', 'item',
                      self.gf('django.db.models.fields.CharField')(default='cabbage', max_length=140),
                      keep_default=False)

        # Deleting field 'Item.item_description'
        db.delete_column(u'items_item', 'item_description')

        # Deleting field 'Item.note'
        db.delete_column(u'items_item', 'note')
    ...
    models = {
        ...
        u'items.item': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'item_description': ('django.db.models.fields.CharField', [], {'max_length': '140'}),
            'item_stamp': ('django.db.models.fields.CharField', [], {'max_length': '60'}),
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'item_modifications'", 'to': u"orm['auth.User']"}),
            'modified_on': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'note': ('django.db.models.fields.TextField', [], {'max_length': '140', 'null': 'True', 'blank': 'True'}),
            'orderlist': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['orders.OrderList']", 'null': 'True', 'blank': 'True'})
        },
        u'orders.order': {
